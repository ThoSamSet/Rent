  ...
  return (
    <>
      <div className="booking-mobile-bar" data-booking-mobile-bar hidden>
        ...
        <button type="button" className="btn btn--solid booking-mobile-bar__cta" data-booking-sheet-open>
          Xem tóm tắt
        </button>
      </div>
      ...
      <div className="booking-mobile-sheet" data-booking-mobile-sheet hidden aria-hidden="true">
        ...
        <div className="booking-mobile-sheet__panel tone-paper" role="dialog" aria-modal="true" aria-label="Tóm tắt đặt lịch">
          <div className="booking-mobile-sheet__header">
            <h2 className="booking-mobile-sheet__title">Tóm tắt</h2>
            <button type="button" className="booking-mobile-sheet__close" data-booking-sheet-close aria-label="Đóng">
              Đóng
            </button>
          </div>
