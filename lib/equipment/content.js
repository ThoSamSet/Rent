...
export const EQUIPMENT_CATEGORIES = [
  {
    ...
    images: [
      ...
      { src: '/images/equipment-sleep.webp', alt: 'Túi ngủ, thảm bạc và chăn theo mùa', caption: 'Túi ngủ · thảm bạc · chăn theo mùa' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/images/option-xem-phim.webp', alt: 'Xem phim ngoài trời — màn chiếu trước lều', caption: 'Máy chiếu Full HD', note: '※ báo trước' },
    ],
  },
];
