...
export const FAQ_COVER = {
  kicker: 'Hỏi đáp',
  title: ['Những điều', '*hay được hỏi.*'],
  deck: 'Những câu khách hỏi tụi mình nhiều nhất, từ chuyện đặt lịch, đi lại, cho tới đêm đầu tiên ngủ ngoài trời. Gõ vài chữ để tìm nhanh, hoặc đọc dần từng nhóm.',
};
...
export const FAQ_CATEGORIES = [
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "answerHtml": "<p>Hoàn toàn được.</p>\n                    <p>Camp Nhà Thỏ phù hợp cho:</p>\n                    <ul>\n                        <li>Đi một mình</li>\n                        <li>Couple</li>\n                        <li>Nhóm bạn nhỏ, gia đình ít người (tối đa 5 người, riêng Hạt Bí tối đa 4 người)</li>\n                    </ul>\n                    <p>Lịch trình linh hoạt theo nhu cầu của bạn.</p>"
      },
      {
        "id": "max-people",
        "question": "Có thể đi tối đa bao nhiêu người?",
        "answerHtml": "<p>Tuỳ plan:</p>\n                    <ul>\n                        <li><strong>Hạt Dẻ</strong> và <strong>Hạt Nho</strong>: tối đa <strong>5 người</strong></li>\n                        <li><strong>Hạt Bí</strong>: tối đa <strong>4 người</strong></li>\n                    </ul>\n                    <p>Nếu nhóm đông hơn, vui lòng liên hệ để được tư vấn thêm.</p>\n                    <p>Hiện tại <strong>không nhận trẻ em dưới 6 tuổi</strong> để đảm bảo an toàn.</p>"
      },
      {
      ...
      {
        "id": "which-plan",
        "question": "Hạt Dẻ, Hạt Bí và Hạt Nho khác nhau thế nào? Nên chọn plan nào?",
        "answerHtml": "<p>Cả ba plan đều có <strong>đủ bộ đồ camping</strong>, tụi mình <strong>đặt bãi giúp, dựng trại và thu dọn trại</strong>. Chỉ khác ở chỗ ai cầm lái và tối đó bạn ngủ ở đâu:</p>\n                    <ul>\n                        <li><strong>Hạt Dẻ</strong>: bạn tự lái xe tới bãi, tới nơi là trại đã dựng xong. Hợp với nhóm có xe, thích tự do dừng đâu tuỳ ý.</li>\n                        <li><strong>Hạt Bí</strong>: tụi mình đón tận nơi và đưa về, ngủ lều / shelter. Hợp với nhóm không có xe, muốn đi trọn gói.</li>\n                        <li><strong>Hạt Nho</strong>: đón tận nơi, tối vẫn ngồi bên lửa nhưng ngủ bungalow có điều hoà và futon. Hợp với người ngại lạnh, ngại mưa hoặc chưa quen ngủ lều.</li>\n                    </ul>\n                    <p>Xem so sánh chi tiết ở trang <a href=\"/pricing\">Chi phí</a>.</p>"
      },
      {
        "id": "kids-elderly",
        "question": "Có mang theo trẻ nhỏ hoặc người lớn tuổi được không?",
        "answerHtml": "<p>Tụi mình nhận <strong>trẻ em từ 6 tuổi trở lên</strong>, đi cùng bố mẹ. Trẻ em được tính như một người trong nhóm.</p>\n                    <p>Hiện tại <strong>chưa nhận trẻ dưới 6 tuổi</strong> để đảm bảo an toàn.</p>\n                    <p>Người lớn tuổi đi được. Nếu trong nhóm có người ngại lạnh hoặc khó ngủ lều, tụi mình gợi ý plan <strong>Hạt Nho</strong> (bungalow có điều hoà).</p>"
      },
      {
        "id": "pets",
        "question": "Có mang theo thú cưng được không?",
        "answerHtml": "<p>Hiện tại Camp Nhà Thỏ <strong>chưa nhận thú cưng</strong>.</p>\n                    <p>Lý do là đồ camping được dùng chung cho nhiều nhóm, và có khách bị dị ứng lông thú.</p>"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "id": "price-by-people",
        "question": "Giá thay đổi thế nào theo số người?",
        "answerHtml": "<p>Giá tính <strong>cho cả nhóm</strong>, nhóm càng đông thì mỗi người trả càng ít.</p>\n                    <p>Ví dụ plan <strong>Hạt Bí</strong> (2 ngày 1 đêm):</p>\n                    <ul>\n                        <li>1 người: 4.7 man</li>\n                        <li>2 người: 5.4 man</li>\n                        <li>3 người: 6 man</li>\n                        <li>4 người: 6.8 man</li>\n                    </ul>\n                    <p>Giá đầy đủ của cả ba plan có ở trang <a href=\"/pricing\">Chi phí</a>. Form <a href=\"/dat-lich\">đặt lịch</a> cũng tự tính tổng tiền cho nhóm bạn.</p>"
      },
      {
        "id": "payment-timing",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "answerHtml": "<p>Hiện tại, Camp Nhà Thỏ <strong>chưa hỗ trợ ghép xe hoặc nối chuyến</strong><br />(ví dụ: bạn tự đi xe riêng rồi tập trung tại bãi camp).</p>\n                    <p>Lý do:</p>\n                    <ul>\n                        <li>Số lượng đồ camping chỉ phục vụ tối đa <strong>5 người</strong></li>\n                        <li>Bãi cắm trại có <strong>quy định giới hạn số người, số xe</strong></li>\n                        <li>Đảm bảo chất lượng trải nghiệm cho từng nhóm</li>\n                    </ul>"
      },
      {
        "id": "hat-de-meetup",
        "question": "Đi plan Hạt Dẻ (tự lái tới bãi) thì gặp tụi mình ở đâu, mấy giờ?",
        "answerHtml": "<p>Trước ngày đi, tụi mình gửi bạn <strong>vị trí trại trên Google Maps</strong> và <strong>giờ check-in của bãi</strong>.</p>\n                    <p>Trại sẽ được dựng xong trước giờ đó, bạn cứ lái thẳng tới trại.</p>\n                    <p>Nếu đến trễ, bạn <strong>nhắn trước cho tụi mình</strong>. Tụi mình chờ được, nhưng bạn cần tới trong giờ bãi còn cho xe vào.</p>"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "id": "toilets",
        "question": "Nhà vệ sinh ở bãi thế nào? Ban đêm đi có tối không?",
        "answerHtml": "<p>Bãi nào tụi mình chọn cũng có <strong>nhà vệ sinh sạch sẽ</strong>, đa số là kiểu Nhật hiện đại.</p>\n                    <p>Tuỳ bãi, từ trại đi bộ tới nhà vệ sinh mất vài phút. Tụi mình để sẵn <strong>đèn pin / đèn đeo trán</strong> để bạn đi lại ban đêm.</p>"
      },
      {
        "id": "wildlife",
        "question": "Ở bãi có gấu, côn trùng hay động vật hoang dã không?",
        "answerHtml": "<p>Tụi mình chỉ chọn <strong>bãi có người quản lý</strong>, theo dõi cảnh báo động vật của địa phương và <strong>đổi bãi nếu cần</strong>.</p>\n                    <p>Mùa ấm thường có muỗi và côn trùng, bạn nhớ <strong>tự mang thuốc chống muỗi / côn trùng</strong>.</p>\n                    <p>Buổi tối trước khi ngủ, đồ ăn được cất vào hộp kín để không thu hút thú rừng.</p>"
      },
      {
        "id": "firewood",
      ...
      },
      {
        ...
        "answerHtml": "<p>Không.</p>\n                    <p>Camp Nhà Thỏ <strong>không còn cung cấp WiFi</strong>.</p>\n                    <p>Bạn có thể dùng 4G/5G trên điện thoại, nhưng do bãi camp thường nằm trên núi,<br /><strong>sóng có thể yếu</strong> hơn bình thường.</p>"
      },
      {
        "id": "sports",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "id": "winter-snow",
        "question": "Mùa đông có tuyết thì có đi không?",
        "answerHtml": "<p>Có. Mùa đông tụi mình vẫn nhận đặt, nhưng sẽ <strong>chọn bãi ít tuyết</strong> như vùng gần biển hoặc vùng thấp.</p>\n                    <p>Nếu tuyết rơi dày hoặc đường bị đóng, tụi mình sẽ <strong>dời lịch miễn phí</strong>.</p>"
      },
      {
        "id": "sightseeing",
