...
/** @type {{ home: HeroSlide[]; about: HeroSlide[]; equipment: HeroSlide[]; locations: HeroSlide[]; options: HeroSlide[]; pricing: HeroSlide[]; schedule: HeroSlide[]; faq: HeroSlide[] }} */
export const HERO_SLIDES = {
  ...
  faq: [
    ...
    },
    {
      baseName: 'camping-2',
      widths: [400, 800, 1200],
      alt: 'Camping Phú Sĩ — cảnh đêm ấm áp',
    },
    {
      baseName: 'camping-3',
      widths: [400, 800, 1200],
