...
export const SCHEDULE_LAST_UPDATED = '2026/08/15';
...
export const SCHEDULE_LEGEND_ITEMS = [
  ...
  {
    swatchClass: 'legend-sale',
    swatchLabel: 'Sale',
    label: 'Sale',
    description: 'ngày giảm giá — vẫn còn chỗ, chạm để đặt',
  },
  {
    swatchClass: 'legend-empty',
    swatchLabel: '-',
    label: '-',
    description: '= không thể đặt lịch vào những ngày này',
  },
  {
